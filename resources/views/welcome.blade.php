...
<head>
    ...
    <!-- Website Title -->
    <title>worguide todo para agilizar el trabajo</title>
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            ...
            <!-- <a class="navbar-brand logo-text page-scroll" href="index.html">workguide</a> -->
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                ...
                <span class="nav-item">
                    @if (Route::has('login'))
                    @auth
                        <a class="btn-outline-sm" href="#">Ingresar</a>
                    @else
                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-5">
                        <div class="text-container">
                            ...
                            <p class="p-large">Use workguide to automate your marketing actions in order to reach a much larger audience</p>
                            @if (Route::has('login'))
                            @auth
                                <a class="btn-solid-lg page-scroll" href="#">Ingresar</a>
                            @else
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>It's very easy to start creating email lists for your marketing actions. Just create your workguide account</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Campaigns is a feature we've developed since the beginning because it's at the core of workguide's functionalities</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>workguide collects customer data in order to help you analyse different situations and take required action</p>
                        </div>
                    </div>
                    <!-- end of card -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="p-heading">Take your business strategy to the next level and automatize your marketing tasks to save time for product development. workguide can provide results in less than 2 weeks</p>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="text-container">
                                        ...
                                        <p>It's very easy to start using workguide. You just need to fill out and submit the <a class="blue page-scroll" href="sign-up.html">Sign Up Form</a> and you will receive access to the app and all of its features in no more than 24h.</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="text-container">
                                        ...
                                        <p>Campaigns monitoring is a feature we've developed since the beginning because it's at the core of workguide and basically to any marketing activity focused on results.</p>
                                        <ul class="list-unstyled li-space-lg">
                                            <li class="media">
                                                <i class="fas fa-square"></i>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <hr>
                    <h5>Core service</h5>
                    <p>It's very easy to start using workguide. You just need to fill out and submit the Sign Up Form and you will receive access to the app.</p>
                    <ul class="list-unstyled li-space-lg">
                        <li class="media">
                ...
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            ...
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Targeted client base with workguide's efficient technology</div>
                            </li>
                        </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="p-heading">What better way to show off workguide marketing automation saas app than presenting you some great situations of each module and tool available to users in a video</div>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    </div> <!-- end of basic-2 -->
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="text-wrapper">
                                        <div class="testimonial-text">I started to use workguide with the free trial about a year ago and never stopped since then. It does all the repeating marketing tasks and allows me to focus on core development activities like new product research and design. I love it and recommend it to everyone.</div>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="text-wrapper">
                                        <div class="testimonial-text">Awesome features for the money. I never thought such a low ammount of money would bring me so many leads per month. Before workguide I used the services of an agency which cost 10x more and delivered far less. Highly recommended to marketers focused on results.</div>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="text-wrapper">
                                        <div class="testimonial-text">workguide is the best marketing automation app for small and medium sized business. It understands the mindset of young entrepreneurs and provides the necessary data for wise marketing decisions. Just give it a try and you will definitely not regret spending your time.</div>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="text-wrapper">
                                        <div class="testimonial-text">worguide is one of the greatest marketing automation apps out there. I especially love the Reporting Tools module because it gives me such a great amount of information based on little amounts of input gathered in just few weeks of light weight usage. Recommended!</div>
                    ...
                    <div class="text-container">
                        ...
                        <form id="newsletterForm" data-toggle="validator" data-focus="false">
                            ...
                            <div class="form-group checkbox">
                                <input type="checkbox" id="nterms" value="Agreed-to-Terms" required>I've read and agree to workguide's written <a href="privacy-policy.html">Privacy Policy</a> and <a href="terms-conditions.html">Terms Conditions</a>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
