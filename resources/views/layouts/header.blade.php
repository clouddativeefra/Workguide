                ...
                <ul class="navbar-nav">
                    <li class="nav-item fw-semibold d-none d-lg-block ms-0">
                        ...
                        <h1 class="welcome-text">
                            Buenos días, <span class="text-black fw-bold">{{ Auth::user()->name }}</span>
                        </h1>
                    @else
                        <h1 class="welcome-text">
                            Buenos días, <span class="text-black fw-bold">Invitado</span>
                        </h1>
                    @endauth

                        <h3 class="welcome-sub-text">
                            Su resumen de desempeño esta semana</h3>
                    </li>
                </ul>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="false"
                            ...
                            <span class="menu-title">Centro Administración</span>
